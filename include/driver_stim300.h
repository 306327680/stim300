...
public:
  DriverStim300(SerialDriver& serial_driver,
                stim_300::DatagramIdentifier datagram_id = stim_300::DatagramIdentifier::RATE_ACC_INCL_TEMP,
                ...
                SerialDriver::BAUDRATE baudrate = SerialDriver::BAUDRATE::BAUD_115200,
  ...
  double getGyroZ() const;
	double getIncX() const;
	double getIncY() const;
	double getIncZ() const;
